...
(** [parse content] parses the text content of a CM file into {!t}.
    Lines before [is] (after the group type keyword) are discarded.
    Source files ([.sml], [.sig], [.fun]) become {!t.sources}.
    Dependency files ([.cm]) become {!t.dependencies}. *)
val parse : string -> t
